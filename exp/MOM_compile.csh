...
set echo
set platform      = cheyenne      # A unique identifier for your platfo
...
#    cc -O -o $mppnccombine -I/usr/local/include -L/usr/local/lib $code_dir/postprocessing/mppnccombine/mppnccombine.c -lnetcdf
    cc -O -o $mppnccombine -I/glade/u/apps/ch/opt/netcdf/4.4.1.1/intel/17.0.1/include $code_dir/postprocessing/mppnccombine/mppnccombine.c -lnetcdf -L/glade/u/apps/ch/opt/netcdf/4.4.1.1/intel/17.0.1/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.4.1.1/intel/17.0.1/lib
