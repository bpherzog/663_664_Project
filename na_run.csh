...
set exp_name  =  TEST_NA                             # experiment name
...
#### run MOM_TEST
  ...
  if ( -e $mom_run_dir/time_stamp.out ) then
    ...
    echo "all *.out files were removed from $mom_run_dir"
    echo
  endif
...
#### archive results
  ...
  mv -f $mom_run_dir/history/soda4_na* $soda_archive/ORIGINAL/      # archive test results
